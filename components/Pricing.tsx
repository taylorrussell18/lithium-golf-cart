      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-[#0f2744] to-[#1a4a7a] border border-[#22d3ee]/30 rounded-2xl p-10 sm:p-14 text-center shadow-2xl shadow-black/40 overflow-hidden">
          ...
          <div className="relative">
            <p className="font-inter text-[#22d3ee]/70 text-sm tracking-widest uppercase mb-2">All-In Price</p>
            <div
              className="font-playfair text-[#22d3ee] font-bold leading-none mb-3"
              style={{ fontSize: "clamp(5rem, 15vw, 8rem)", textShadow: "0 4px 30px rgba(34,211,238,0.25)" }}
            >
              $1,600
            </div>
            <p className="font-inter text-white/70 text-lg mb-10">Parts + Labor — No hidden fees, ever.</p>
            ...
            <div className="bg-amber-900/30 border border-amber-500/30 rounded-lg px-5 py-3 mb-10 inline-block">
              <p className="font-inter text-amber-300 text-sm font-medium">
                ⚠️ Limited weekly install spots available — book early to secure your date.
              </p>
            </div>
        ...
        <p className="text-center font-inter text-white/30 text-xs mt-6">
          Price is for standard 36V golf cart conversions. Contact us for non-standard configurations.
        </p>
      </div>
    </section>
  );
